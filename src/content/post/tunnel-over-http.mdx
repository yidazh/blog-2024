...
<Image src="/images/2014-05-20_23-58-18.png" width={1155} height={861} alt="" />

开启Fiddler的HTTPS解密后，再看看CONNECT请求里的具体内容吧，一个CONNECT对应一个HTTPS，均是请求到GAE代理APP：appid.appspot.com

<Image src="/images/2014-05-20_23-58-19.png" width={1155} height={861} alt="" />
...
<iframe
  ...
  name="embed_dom"
  frameborder="0"
  style="border:1px solid #000;display:block;width:900px; height:700px;"
  src="http://www.processon.com/embed/537ca51f0cf27549ed2e26a0"
></iframe>
...
<Image src="/images/2014-05-20_23-58-20.png" width={1155} height={861} alt="" />
...
- [Tunnel over HTTPS](http://stackoverflow.com/questions/181341/tunnel-over-https)
- [Tunneling SSH over HTTP(S)](http://dag.wiee.rs/howto/ssh-http-tunneling/)
- [Tunnel SSH Connections Over SSL Using ‘Stunnel’ On Debian 7 / Ubuntu 13.10](http://www.unixmen.com/tunnel-ssh-connections-ssl-using-stunnel-debian-7-ubuntu-13-10/)
- [SSH over Stunnel for IDS evasion](http://securityweekly.com/2013/05/ssh-over-stunnel-for-ids-evasi.html)
- [How is tunnelling SSH through Poxytunnel/HTTPS different from doing it through SSL with Stunnel?](http://security.stackexchange.com/questions/7923/how-is-tunnelling-ssh-through-poxytunnel-https-different-from-doing-it-through-s)
- [SSH Through or Over Proxy](http://daniel.haxx.se/docs/sshproxy.html)
- [HTTP Tunnel使用的几种使用（经典）](http://blog.csdn.net/zhangxinrun/article/details/5942260)
